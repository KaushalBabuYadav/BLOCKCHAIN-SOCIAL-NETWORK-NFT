<html>
  ...
  <body>
  	  	...
  	  	<div id="login">
  	  		...
  	  		<br/> -->
  	  		<a style="font-size: 20px; padding-left: 10px; " href="signup.jsp"><img src="images/register.png"></a>
  	  	</div>
  	  	 	<br/> 	<br/> 	<br/>
  
  	  		<div id="login">
  	  		<!-- <label style="display: block; text-align: center;font-size: 30px;font-family: sans-serif; ">Admin Login</label>
  	  		<br/> -->
  	  	 <a style="font-size: 20px; padding-left: 30px; " href="login.jsp"><img src="images/login.png"></img></a>
  	  	</div>
