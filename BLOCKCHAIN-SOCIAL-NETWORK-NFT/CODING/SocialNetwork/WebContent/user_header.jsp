...
.dropdown:hover .dropbtn {text-decoration: underline;}
  ...
  <body>
	...
	<div id="nav">
		<div class="dropdown">
  				<a href="user_home.jsp" class="dropbtn">Home</a>
		</div>
		<div class="dropdown">
  				<a href="user_request.jsp" class="dropbtn">Requests</a>
		</div>
		
		<div class="dropdown">
  				<a href="user_notification.jsp" class="dropbtn">Notifications</a>
		</div>
		<div class="dropdown">
  				<a href="user_view_recomm.jsp" class="dropbtn">View Recommendation</a>
		</div>
