...
<%@page import="com.dao.ImageDAO"%><html>
	...
	<body>
		...
		<div id="main">
			...
			<div id="home">
				<p style="margin: 0px;margin-top: 5px;text-align: center;font-family:cursive;font-size: 20px;background:lime;  ">Notifications</p>
				<div style="width:96%; height: 92.5%; border: 1px solid gray; margin-top: 10px; padding: 10px;">
					 <%
						List<String> lis =UserDAO.getNotification(C_user);
						if(lis.size()>0){
							for(String s:lis){
					%>
							<p style="margin:10px;padding:10px;font-family: cursive;font-size: 20px; background: #eee;"><%=s %></p>	
					<%			
							}	
						}
					 %>
