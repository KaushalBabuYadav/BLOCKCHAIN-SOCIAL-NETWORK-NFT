...
<%@page import="com.beans.UploadImg"%>
<%@page import="com.dao.RecommDAO"%><html>
	<head>
	...
	<body>
		...
		<br/><hr/>
		<div id="main">
			<p>Image Recommendations based on Upload history</p>
			<a href="user_view_recomm.jsp" style="color: blue; font-size: 20px; font-family: cursive;">back</a>
			
			<div style="padding: 35px;">
				<%
					List<UploadImg> list =RecommDAO.getUHRecomm((String)session.getAttribute("user"));
					int count=0;
					if(list.size()>0){
